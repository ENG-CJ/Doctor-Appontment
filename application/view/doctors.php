    ...
    $(document).ready(function() {
            ...
            function displayDoctorsIntoTable(data) {
                ...
                data.forEach(values => {
                    ...
                    tr += `<td>
                            <a class="btn btn-success viewBtn text-light" viewID="${values.dr_id}">
                            <i class="fa-solid fa-eye"></i>
                            </a>
                            <a class="btn btn-danger deleteButton text-light" delID="${values.dr_id}"><i class="fa-solid fa-xmark"></i></a></td>`;
                    tr += "</tr>";
                });
                $(".table tbody").html(tr);
                $(".table").DataTable();
