...
$sql = "SELECT *FROM doctors JOIN proffision on doctors.profision_id=proffision.pro_id where dr_id='$id'";
                                                ...
                                                <form>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" hidden value="<?php echo $data['image'] ?>" placeholder="Email" class="form-control default_profile w-100">
                                                        </div>
        ...
        $('.saveChanges').click((e) => {
            ...
            if ($(".name").val() == "" || $(".email").val() == "" ||
                ...
                if ($(".new_profile")[0].files.length > 0) {
                    ...
                    data.append("action", "updateDoctorWithProfile")
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        if (res.error != "") {
                            showInfoOrErrorMessages(res.message, $(".info-body"), "error")
                            return;
                        }
                        showInfoOrErrorMessages(res.message, $(".info-body"), "success")
